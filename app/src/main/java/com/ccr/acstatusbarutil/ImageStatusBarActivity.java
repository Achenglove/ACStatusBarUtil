...
public class ImageStatusBarActivity extends BaseActivity {
    ...
    protected void setStatusBar() {
        if (isTransparent) {
            ACStatusBarUtil.setTransparent(this);
        } else {
            ACStatusBarUtil.setTranslucent(this, ACStatusBarUtil.DEFAULT_STATUS_BAR_ALPHA);
        }
    }
    ...
    private void setSeekBar() {
        ...
        mSbChangeAlpha.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mAlpha = progress;
                ACStatusBarUtil.setTranslucent(ImageStatusBarActivity.this, mAlpha);
